                ...
                <div class="accordion-content" style="display:<?php echo $index === 0 ? 'block' : 'none'; ?>;">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 d-flex flex-column align-items-start">
                            ...
                            if ($button_accordion) : ?>
                                <a href="<?php echo esc_url(get_permalink($servizio->ID)); ?>" class="btn btn-mine mt-2 btn-small"><?php echo esc_html($button_accordion); ?></a>
                            <?php else : ?>
                                <a href="<?php echo esc_url(get_permalink($servizio->ID)); ?>" class="btn btn-mine btn-small mt-2">Scopri i dettagli</a>
                            <?php endif; ?>
                        </div>
                    </div>
                </div>
