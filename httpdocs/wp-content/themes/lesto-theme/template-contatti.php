						 ...
						 <form action="#" method="post">
                            <div>
							 ...
							 <div class="mb-3">
								 ...
								 <textarea class="form-control header-buttons" id="messaggio" name="messaggio" rows="4" required></textarea>
							 </div>
							 ...
							 <div class="form-check mt-4 d-flex gap-4">
								 ...
								 <p class="form-check-label m_p1" for="privacy">
									 Confermo di aver preso visione della privacy policy e acconsento al trattamento dei dati personali ai sensi dell'art. 13 del D.Lgs 196/2003 e dell'art. 13 del Regolamento UE 679/2016 per ricevere risposta
								 </p>
							 </div>
						 </form>
					 </div>
